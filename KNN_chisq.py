...
X = data_normalized.iloc[:, :-1]  # Fitur
y = data_normalized.iloc[:, -1]  # Target

# Inisialisasi objek SelectKBest untuk seleksi fitur
k_best = SelectKBest(score_func=chi2, k=8)  # Memilih 8 fitur terbaik
...
print("Fitur terpilih setelah seleksi menggunakan Chi-Square:")
...
print("PEMODELAN DENGAN KNN".center(75, "="))
knn_classifier = KNeighborsClassifier(
    n_neighbors=5
)  # Anda bisa mengatur jumlah tetangga sesuai kebutuhan
...
print("CLASSIFICATION REPORT KNN".center(75, "="))
# Menghitung akurasi
