...
# 4 Seleksi Fitur
# Seleksi fitur menggunakan Feature Importance dengan Random Forest Classifier
...
print("Fitur terpilih berdasarkan Feature Importance:")
print(selected_features)

# Membuat dataset baru hanya dengan fitur terpilih
